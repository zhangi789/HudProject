...
/**
 * Created by Zheng Jungen on 2017/3/10.
 */
public class ProgressView extends View {
    ...
    public ProgressView(Context context, AttributeSet attrs) {
        ...
        try {
            mBgColor = a.getColor(R.styleable.ProgressView_bgColor, 0xffe1e1e1);
            mFgColorEnd = a.getColor(R.styleable.ProgressView_fgColorEnd, 0xffff4800);
            mFgColorStart = a.getColor(R.styleable.ProgressView_fgColorStart, 0xffffe400);
            mPercent = a.getFloat(R.styleable.ProgressView_percent, 0);
            mStartAngle = a.getFloat(R.styleable.ProgressView_startAngle, 0)+270;
            mStrokeWidth = a.getDimensionPixelSize(R.styleable.ProgressView_strokeWidth, dp2px(21));
