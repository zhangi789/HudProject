 ...
 */
public class BaiduIndexAdapter extends BaseAdapter {
    private ArrayList<BaiduIndexBean> mBaiduInfo;
    private LayoutInflater layoutInflater;
    private Context context;

    public BaiduIndexAdapter(Context context,ArrayList<BaiduIndexBean> mBaiduInfo) {
