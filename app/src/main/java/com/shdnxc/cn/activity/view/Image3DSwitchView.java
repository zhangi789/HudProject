...
public class Image3DSwitchView extends ViewGroup {
	...
	private OnImageSwitchTouchLisener  mTouchLisener;
	/**
	 * 记录当前的触摸状态
	 */
	...
	public void OnImageSwitchTouchLisener(OnImageSwitchTouchLisener listener) {
		mTouchLisener = listener;
	}
	...
	public interface OnImageSwitchTouchLisener{
		/**
		 * 当图片滚动时会回调此方法
		 *
		 * @param currentImage
		 *            当前图片的坐标
		 */
		void onImageSwitchOnTouch(int currentImage);
	}
}